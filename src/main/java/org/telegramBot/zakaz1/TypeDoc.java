...
public enum TypeDoc {
    ...
    type_7_7_7("Комплект Документов на карту побыту (залончник, умова, КРС)"),
    type_1_2("Карта побыту с внеском"),
    type_1_2_2("Карта побыту с внеском"),
    ...
    type_1_9_1("Код 95 (литовский) с переводом на польский, психотестами и orzeczeniem(короткий)"),
    type_1_9_2("Код 95 (литовский) с переводом на польский, психотестами и orzeczeniem(длинный)"),
